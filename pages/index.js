...
export default function Home() {
  ...
  const handleSwitch = (id) => setCurrOpt(id)

  const currState = {
    currCard: currCard,
    currAnswer: answer,
    currSelected: currSelected,
    option: { currOpt, handleSwitch },
  }
  ...
  useEffect(() => {}, [currCard, currSelected, answer])
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        />
        <Blank in={answer} />
        <Card curr_state={currState} handle_confirm={handleConfirm} handle_select={handleSelect} />
      </main>
